    ...
    document.getElementById("createSongButton").addEventListener("click" , (e) => {
       ...
       //Reset the error
        ...
        if(form.checkValidity()){
            ...
            if(!( genre === "Pop" || genre ==="Reggae" || genre === "Rock" || genre ==="Hip_hop" || genre ==="Classical" || genre ==="Ambient")){
            ...
            console.log("createSong.js requestinf the createSong.java --> ");
                    ...
                    if(x.readyState = XMLHttpRequest.DONE){
                        switch(x.status){
                            case 200:
                                ...
                                console.log("createSong.js success --> ");
